import { fetchGlobalStandings, getAllLeagues } from "@/app/lib/data";
...
export default async function GlobalStandings() {
    ...
    const currentSeason = leagues[0]?.current_season ?? 3;
    const standings = await fetchGlobalStandings(currentSeason);
